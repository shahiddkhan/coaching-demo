...
const GLOBAL_CSS = `
  ...
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .nav-link:hover { color: #F0B429 !important; opacity: 1 !important; }
  .nav-scrolled { color: #1A2B4A !important; }
  .nav-scrolled:hover { color: #0B1C3D !important; }

  .btn-gold {
    background: linear-gradient(135deg, #D4A017, #F0B429);
    color: #0B1C3D; border: none; padding: 13px 28px; border-radius: 8px;
  ...
  .btn-gold:hover { transform: translateY(-2px); box-shadow: 0 8px 32px rgba(212,160,23,0.5); }

  .btn-outline {
    background: transparent; color: #fff;
    border: 2px solid rgba(255,255,255,0.55); padding: 12px 28px;
  ...
  .course-card {
    ...
    box-shadow: 0 4px 28px rgba(11,28,61,0.07);
    border: 1px solid rgba(11,28,61,0.06); transition: all 0.35s;
    position: relative; overflow: hidden; height: 100%;
  }
  .course-card::before {
    content: ''; position: absolute; top: 0; left: 0; right: 0; height: 4px;
    background: linear-gradient(90deg, #0B1C3D, #F0B429);
  }
  .course-card:hover { transform: translateY(-8px); box-shadow: 0 20px 56px rgba(11,28,61,0.14); }

  .faculty-card {
    background: white; border-radius: 18px; padding: 36px 24px;
    text-align: center; box-shadow: 0 4px 24px rgba(11,28,61,0.07); transition: all 0.35s;
  }
  .faculty-card:hover { transform: translateY(-8px); box-shadow: 0 20px 56px rgba(11,28,61,0.14); }

  .testi-card {
    background: white; border-radius: 18px; padding: 36px 32px;
    box-shadow: 0 4px 28px rgba(11,28,61,0.07); transition: all 0.35s; position: relative;
  }
  .testi-card::before {
    content: '"'; position: absolute; top: 12px; left: 24px;
    font-size: 6rem; color: #D4A017; opacity: 0.15;
    font-family: 'DM Serif Display', serif; line-height: 1;
  }
  .testi-card:hover { transform: translateY(-5px); box-shadow: 0 20px 56px rgba(11,28,61,0.12); }

  .form-ctrl {
    width: 100%; padding: 13px 16px;
    border: 2px solid #E4EAF4; border-radius: 10px;
    font-size: 0.93rem; font-family: 'DM Sans', sans-serif;
    color: #1A2B4A; background: white; transition: border-color 0.2s; outline: none;
  }
  .form-ctrl:focus { border-color: #D4A017; }
  ...
  .tag {
    ...
    border: 1px solid rgba(212,160,23,0.28); padding: 6px 18px;
    border-radius: 100px; font-size: 0.75rem; font-weight: 700;
    letter-spacing: 1px; text-transform: uppercase; margin-bottom: 14px;
  }
  .tag-light {
    background: rgba(255,255,255,0.1); color: #F0B429;
  ...
  .section-title {
    ...
    color: #0B1C3D; line-height: 1.2; margin-bottom: 14px;
  }
  .section-sub {
    color: #6B7A99; font-size: 1rem; max-width: 560px;
  ...
  .gold-line::after {
    ...
    height: 3px; background: linear-gradient(90deg, #D4A017, #F0B429); border-radius: 2px;
  }
...
const FACULTY = [
  ...
  },
  {
    ...
    achievements: [
      ...
      "Developed Apex's signature Chemistry test series",
    ],
  },
  {
  ...
  },
  {
    ...
    init: "PN",
    bio: "Dr. Nair holds a Ph.D. from AIIMS Mumbai and is the cornerstone of Apex's NEET Biology program. Her visual teaching methodology — using diagrams, mnemonics, and case studies — makes even the toughest chapters in Botany and Zoology engaging and easy to retain.",
    achievements: [
...
const TESTIMONIALS = [
  {
    ...
    text: "Apex Academy completely transformed my preparation strategy. The faculty's depth of knowledge and personal attention made cracking JEE feel achievable.",
    init: "AK",
  },
  {
    name: "Priya Singh",
    result: "NEET UG — 720/720 Perfect Score",
    text: "Achieving a perfect NEET score seemed impossible until I joined Apex. The structured approach, mock test series, and constant faculty support were extraordinary.",
    init: "PS",
  },
  {
    name: "Rohan Desai",
    result: "Class 12 Boards — 95.8%",
    text: "Regular tests and detailed performance analysis helped me identify weak areas early. Apex Academy truly delivers on every promise it makes to its students.",
    init: "RD",
  },
  {
    name: "Sneha Joshi",
    result: "JEE Mains — AIR 89",
    text: "The study material quality at Apex is unmatched anywhere in Mumbai. Every concept was explained with absolute clarity backed by rigorous practice sessions.",
    init: "SJ",
  },
];
    ...
    >
      <div
        ...
        style={{
          ...
          width: "100%",
          maxWidth: 540,
          boxShadow: "0 32px 80px rgba(11,28,61,0.22)",
          overflow: "hidden",
          position: "relative",
          maxHeight: "90vh",
          overflowY: "auto",
    ...
    >
      ...
      >
        ...
        <button
          ...
          onMouseEnter={(e) =>
            (e.currentTarget.style.background = "rgba(11,28,61,0.14)")
          }
          onMouseLeave={(e) =>
            (e.currentTarget.style.background = "rgba(11,28,61,0.07)")
          }
        >
          ✕
        </button>
    ...
    >
      ...
      <nav
        style={{
          ...
          boxShadow: scrolled ? "0 2px 28px rgba(11,28,61,0.1)" : "none",
      ...
      <section
        ...
        style={{
          minHeight: "100vh",
          background: `linear-gradient(140deg, ${C.navy} 0%, #1a3a6e 55%, #0d2247 100%)`,
          display: "flex",
          alignItems: "center",
          position: "relative",
          overflow: "hidden",
      ...
      >
        ...
        <div
          style={{
            ...
            width: "45%",
            height: "80%",
            background: `radial-gradient(ellipse, rgba(26,58,110,0.6) 0%, transparent 70%)`,
            pointerEvents: "none",
          }}
        />
        {/* Grid texture */}
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                Expert Coaching for{" "}
                <span style={{ color: C.goldBright }}>10th, 11th, 12th</span>
                <br />
                NEET &amp; JEE
              </h1>
              ...
              <Reveal key={i} delay={i * 0.1}>
                <div
                  style={{
                    ...
                    borderRadius: 18,
                    padding: "36px 20px",
                    boxShadow: "0 4px 28px rgba(11,28,61,0.07)",
      ...
      <section
        style={{
          background: `linear-gradient(135deg, ${C.navy}, #1E3D6E)`,
          padding: "72px 28px",
        }}
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 48 }}>
              ...
              >
                Why Choose{" "}
                <span style={{ color: C.goldBright }}>Apex Academy?</span>
              </h2>
            </div>
          </Reveal>
          <div
                ...
                >
                  <div
                    style={{
                      ...
                      justifyContent: "center",
                      margin: "0 auto 22px",
                      boxShadow: "0 8px 28px rgba(11,28,61,0.22)",
                    }}
                  >
                    {f.init}
                  </div>
      ...
      <section
        ...
        style={{
          padding: "100px 28px",
          background: `linear-gradient(140deg, ${C.navy} 0%, #1A3A6E 100%)`,
        }}
      >
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              >
                Proven <span style={{ color: C.goldBright }}>Results</span>
              </h2>
              <p
                style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center" }}>
              ...
              <p className="section-sub">
                Real stories from real achievers who trusted Apex Academy to
                shape their future.
              </p>
            </div>
          </Reveal>
                ...
                <div className="testi-card">
                  ...
                  <div style={{ display: "flex", gap: 2, marginTop: 18 }}>
                    {"★★★★★".split("").map((_, j) => (
                      <span
                        key={j}
                        style={{ color: C.goldBright, fontSize: "1.05rem" }}
                      >
                        ★
                      </span>
                    ))}
          ...
          <Reveal delay={0.1}>
            <div
              style={{
                ...
                borderRadius: 22,
                padding: "52px 44px",
                boxShadow: "0 12px 56px rgba(11,28,61,0.1)",
              }}
            >
              {submitted ? (
            ...
            <Reveal dir="right">
              <div
                style={{
                  borderRadius: 18,
                  overflow: "hidden",
                  boxShadow: "0 8px 40px rgba(11,28,61,0.1)",
                  height: 420,
                }}
              >
                <iframe
                  title="Apex Academy — Mumbai"
      ...
      >
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            ...
            >
              © 2024 Apex Academy. All rights reserved. Mumbai, Maharashtra,
              India.
            </div>
            <div
              style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.82rem" }}
